...
class GameScene extends Phaser.Scene {
    ...
    generateElementDescription(element) {
        ...
        const customDescriptions = {
            ...
            tree_trunk: 'Solid wood • Main structural trunk of trees • Absorbs water from above → gets wet → dries out slowly • Burns → burning wood • Strong building material • Part of tree structure • SEASONAL: Regrows leaves faster in spring (0.01% regrowth rate), occasional decay in autumn/winter (0.001-0.002% → ash) • WATERED: Wet trees (wetness > 20) have 3x leaf growth rate',
            tree_branch: 'Solid wood • Tree branches extending from trunk • Absorbs water from above → gets wet → dries out slowly • Burns → burning wood • Supports leaves • Part of tree structure • SEASONAL: Regrows leaves in spring, may decay and fall off in autumn/winter (0.001-0.002% → movable wood) • WATERED: Wet branches (wetness > 20) have 3x leaf growth rate',
