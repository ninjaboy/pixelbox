...
class HouseBuilderSeedElement extends Element {
    constructor() {
        super(ELEMENT_TYPE.HOUSE_SEED, 'house_seed', 0xFFD700, { // Gold color (visible builder)
    ...
    handleBuilding(cell, x, y, grid) {
        ...
        // Builder steps aside to let construction happen
        // Try to move to the side (left or right)
